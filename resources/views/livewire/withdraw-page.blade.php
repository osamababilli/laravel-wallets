<div x-data="{
    ...
    <div
        ...
        <h1 class="text-xl font-bold flex-1 text-center text-zinc-900 dark:text-white">ينسحب</h1>
        <div class="w-10"></div>
    </div>
    ...
    <div class="max-w-xl mx-auto space-y-6">
        ...
        <div class="bg-zinc-900 text-white rounded-xl p-6 relative overflow-hidden shadow-lg border border-zinc-700">
            <div class="relative z-10">
                <div class="text-sm text-zinc-400 mb-1">حساب السحب</div>
                <div class="text-xs text-orange-400 mb-4">سحب 24 ساعة</div>

                <div class="text-xs text-zinc-400">الرصيد الإجمالي</div>
                <div class="text-3xl font-bold mt-1 tracking-wider">{{ number_format(auth()->user()->balance, 2) }}
